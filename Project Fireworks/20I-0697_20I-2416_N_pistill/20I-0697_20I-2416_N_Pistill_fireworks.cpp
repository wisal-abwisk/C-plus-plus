...
void line_0 (int startrow, int startcol, int endrow, int endcol, char pistill[][40]); //this funtion will be called whereever the zero degrees( horizontal) line is used.
void line_vert (int startrow, int startcol, int endrow, int endcol, char pistill[][40]);//this funtion will be called  whereever the 90 degrees (vertical) line will be used.
...
int main()
{
		...
		//printing the lower vertical lines
...
//this function prints a straight line
